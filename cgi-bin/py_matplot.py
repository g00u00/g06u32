...
def py_matplot():
    ...
    plt.title('Посещаемость страниц приложения', fontsize=14, color='black')
    plt.xlabel('Символы, преобразованные в цифры', fontsize=12, color='black')
    ...
    print('\n<div  style= "display:flex;flex-direction:row; justify-content:space-around; flex-wrap:wrap; align-items:center">')
    print('\n<img width="300px" src="../tmp/matplot_bar.png" >')
    print('\n<img width="300px" src="../tmp/matplot_barh.png" >')
    print('\n<img width="300px" src="../tmp/matplot_scatter.png" >')
    print('\n</div>')
