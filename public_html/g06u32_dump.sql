...
INSERT INTO `db_list` VALUES (1,'1',2,3),(2,'1',2,3),(3,'1',2,3),(4,'1',2,3),(5,'1',2,3),(6,'1',2,3),(7,'1',2,3),(8,'1',2,3),(9,'1',2,3),(10,'1',2,3),(11,'1',2,3);
...
INSERT INTO `form_processing` VALUES (1,'d1',2,5,'Доходы','2022-02-05','20:38:44'),(2,'d2',2,5,'Доходы','2022-02-05','20:38:59'),(3,'r1',0,0,'Расходы','2022-02-05','20:39:38'),(4,'asd',43,34,'Доходы','2022-02-17','08:25:09'),(5,'asdf',5,4,'Доходы','2022-02-17','08:38:10'),(6,'молоко',50,5,'Расходы','2022-02-17','08:46:47'),(7,'сахар',55,55,'Доходы','2022-02-17','09:21:23');
/*!40000 ALTER TABLE `form_processing` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `g03u24_db_swap_uneven_numbers`
--

DROP TABLE IF EXISTS `g03u24_db_swap_uneven_numbers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `g03u24_db_swap_uneven_numbers` (
  `g03u24_task` text,
  `g03u24_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `g03u24_db_variable_1` int(10) NOT NULL,
  `g03u24_db_result` int(10) DEFAULT NULL,
  `g03u24_db_real_result` int(10) DEFAULT NULL,
  `g03u24_db_date` date NOT NULL,
  `g03u24_db_time` time NOT NULL,
  PRIMARY KEY (`g03u24_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `g03u24_db_swap_uneven_numbers`
--

LOCK TABLES `g03u24_db_swap_uneven_numbers` WRITE;
/*!40000 ALTER TABLE `g03u24_db_swap_uneven_numbers` DISABLE KEYS */;
INSERT INTO `g03u24_db_swap_uneven_numbers` VALUES ('Дано целое десятичное число. Переставить местами его крайние цифры при условии, что они нечётные.',1,12345,52341,52341,'2022-01-27','23:58:57'),('Дано целое десятичное число. Переставить местами его крайние цифры при условии, что они нечётные.',2,12345,52341,52341,'2022-01-27','23:59:01');
/*!40000 ALTER TABLE `g03u24_db_swap_uneven_numbers` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-03-09 18:18:46
